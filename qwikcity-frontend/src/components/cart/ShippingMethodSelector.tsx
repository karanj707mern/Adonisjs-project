            ...
            return (
              ...
              >
                <div class="flex items-start justify-between gap-4">
                  <div>
                    <p
                      class={`text-sm font-semibold text-center sm:text-left ${
                        isSelected
                    ...
                    <p
                      class={`mt-1 text-sm text-center sm:text-left ${
                        isSelected
                  ...
                  <span
                    class={`text-sm font-semibold whitespace-nowrap text-center sm:text-left ${
                      isSelected
                        ? "text-emerald-700 dark:text-emerald-400"
                        : "text-[var(--text-primary)]"
                    }`}
