...
export default component$(() => {
  ...
  return (
    <div class="space-y-8">
      <section
        id="product-form-top"
        class="rounded-[2rem] border border-slate-200 bg-slate-50 p-5 shadow-sm sm:p-8 dark:border-slate-800 dark:bg-slate-900"
      >
        ...
        >
          <input
            ...
            value={form.name}
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["name"] = el.value)
            }
            required
          ...
          <div class="grid gap-4 md:grid-cols-2">
            <input
              ...
              value={form.slug}
              onInput$={(_, el) =>
                ((form as Record<string, unknown>)["slug"] = el.value)
              }
              required
              class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
            />
            <input
              ...
              value={form.sku}
              onInput$={(_, el) =>
                ((form as Record<string, unknown>)["sku"] = el.value)
              }
              required
              class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
            />
          ...
          <input
            ...
            value={form.price}
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["price"] = el.value)
            }
            required
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
          <input
            ...
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["compareAtPrice"] = el.value)
            }
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
          <input
            ...
            value={form.stock}
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["stock"] = el.value)
            }
            required
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
          <div class="grid gap-4 md:grid-cols-2">
            <input
              ...
              value={form.brand}
              onInput$={(_, el) =>
                ((form as Record<string, unknown>)["brand"] = el.value)
              }
              class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
            />
          </div>
          <input
            ...
            value={form.tags}
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["tags"] = el.value)
            }
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
          <input
            ...
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["weightGrams"] = el.value)
            }
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
          <input
            ...
            value={form.image}
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["image"] = el.value)
            }
            required
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
          ...
          {(localImagePreview.value || form.image) && (
            <div class="overflow-hidden rounded-[1.5rem] border border-slate-200 bg-slate-100 dark:border-slate-800 dark:bg-slate-800">
              <img
                src={resolveImageUrl(localImagePreview.value || form.image)}
                alt="Product preview"
          ...
          <textarea
            ...
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["description"] = el.value)
            }
            rows={5}
            required
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          ...
          <input
            ...
            value={form.seoTitle}
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["seoTitle"] = el.value)
            }
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
          <textarea
            ...
            onInput$={(_, el) =>
              ((form as Record<string, unknown>)["seoDescription"] = el.value)
            }
            rows={3}
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
          <label class="flex items-center gap-3 rounded-2xl bg-slate-100 px-4 py-3 text-sm text-slate-700 dark:bg-slate-800 dark:text-slate-300">
            <input
              ...
              onChange$={(_, el) =>
                ((form as Record<string, unknown>)["isActive"] = (
          ...
          <label class="flex items-center gap-3 rounded-2xl bg-slate-100 px-4 py-3 text-sm text-slate-700 dark:bg-slate-800 dark:text-slate-300">
            <input
              ...
              onChange$={(_, el) =>
                ((form as Record<string, unknown>)["isNewArrival"] = (
                  el as HTMLInputElement
                ).checked)
              }
            />
      ...
      <section class="admin-card rounded-xl p-4 shadow-sm sm:p-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
          ...
          <div class="rounded-full bg-slate-100 px-3 py-1.5 text-sm text-slate-600 dark:bg-slate-800 dark:text-slate-400">
        ...
        {loading.value ? (
          <div class="mt-6 rounded-xl border border-dashed border-slate-300 p-5 text-sm text-slate-500 dark:border-slate-700">
            Loading products…
          </div>
        ) : products.length === 0 ? (
          <div class="mt-6 rounded-xl border border-dashed border-slate-300 p-5 text-sm text-slate-500 dark:border-slate-700">
          ...
          <div class="mt-6 space-y-3">
            {products.map((product) => (
              <article
                ...
                class="admin-card grid gap-3 rounded-xl border border-slate-200 p-3 md:grid-cols-[96px_1fr] dark:border-slate-800"
              >
                {product.image ? (
                  <img
                  ...
                  <div class="flex h-24 w-full items-center justify-center rounded-[1rem] border border-dashed border-slate-300 bg-slate-100 text-xs uppercase tracking-wider text-slate-400 dark:border-slate-700 dark:bg-slate-800">
                    No image
                  </div>
                )}
                <div class="flex flex-col justify-between gap-3">
                  <div class="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div class="space-y-1.5">
                      <div class="rounded-full bg-slate-100 px-3 py-1 text-xs uppercase tracking-wider text-slate-600 dark:bg-slate-800 dark:text-slate-400">
                        Stock {product.stock as number}
                      </div>
                      <div
                        class={`rounded-full px-3 py-1 text-xs uppercase tracking-wider ${product.isActive ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300" : "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400"}`}
                      >
