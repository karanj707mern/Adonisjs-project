...
export default component$(() => {
  return (
    <InfoPage title="About Us" subtitle="Why we're obsessed with moringa.">
      <p>
      ...
      <p>
        Every product passes through rigorous lab testing for purity and
        potency before it reaches your door. From leaf powder to cold-pressed
        oils, we keep processing minimal so the nutrition stays intact.
      </p>
