...
export default function AdminGiftCards({ initialGiftCards, initialError }: Props) {
              ...
              >
                <div>
                  ...
                  <div className="mt-3 flex flex-wrap gap-4 text-sm text-[var(--text-secondary)]">
                    <span>
                      Initial: {formatCurrency(giftCard.initialAmount, giftCard.currency)}
                    </span>
                    <span>
                      Remaining: {formatCurrency(giftCard.remainingAmount, giftCard.currency)}
                    </span>
