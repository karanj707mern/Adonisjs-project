...
export function useOrdersLogic() {
  ...
  const handleLogout = useCallback(async () => {
    ...
    navigate("/auth?from=" + encodeURIComponent("/orders"));
  }, [navigate]);
  ...
  }, [authChecked, currentUserId, redirectToAuth]);
  ...
  }, [authChecked, currentUserId, currentUserRole, toast]);
