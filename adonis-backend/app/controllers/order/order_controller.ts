...
import { createOrderValidator, verifyPaymentValidator, updateOrderValidator, refundOrderValidator, createOrderIssueValidator, updateOrderIssueValidator, queryOrderValidator } from './order_validators'
...
export default class OrderController {
  ...
  async verifyPayment(ctx: HttpContext) {
    ...
    return this.orderService.verifyPayment(userId, data.orderId, data.razorpayOrderId, data.razorpayPaymentId, data.razorpaySignature)
  }
