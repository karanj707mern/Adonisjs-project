...
import { UnauthorizedException, BadRequestException } from '@adonisjs/core/http'
...
export default class AuthController {
  ...
  async refresh({ request, response }: HttpContext) {
    ...
    response.cookie('refreshToken', result.refreshToken, this.getAuthCookieOptions(7 * 24 * 60 * 60 * 1000))
