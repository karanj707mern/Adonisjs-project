...
import { UnauthorizedException, BadRequestException, ConflictException, NotFoundException } from '@adonisjs/core/http'
...
export default class AuthService {
  ...
  private async buildAuthResponse(
    userId: number,
    message: string,
    deviceInfo?: DeviceInfoService['extractDeviceInfo'] extends (arg: infer A) => infer R ? R : never
  ...
  async updateProfile(
    ...
    if (dto.country !== undefined) data.country = String(dto.country).trim() || null
    if (dto.avatar !== undefined) data.avatar = String(dto.avatar).trim() || null
