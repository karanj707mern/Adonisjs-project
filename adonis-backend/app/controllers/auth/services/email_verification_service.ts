...
export default class EmailVerificationService {
  ...
  async sendWelcome(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendEmailVerified(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendProfileUpdated(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendAddressAdded(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendAddressUpdated(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendAddressDeleted(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendReviewPosted(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendCommentPosted(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendBlogPosted(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendBlogUpdated(email: string, name: string, userId?: number): Promise<null> {
    return null
  }

  async sendBlogDeleted(email: string, name: string, userId?: number): Promise<null> {
    return null
  }
