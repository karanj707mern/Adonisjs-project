...
import AnalyticsService from './analytics_service.ts'
import { salesStatsQueryValidator } from './analytics_validators.ts'
...
export default class AnalyticsController {
  ...
  async getRecoverableCarts({ auth }: HttpContext) {
    ...
    return this.analyticsService.getRecoverableCarts(userId, undefined)
  }
