...
export default function registerBlog(router) {
  router
    .group(() => {
      router
      ...
      router
        .post('blog', [BlogController, 'createPost'])
        .middleware('auth')
        .middleware('admin');
      ...
      router
        .patch('blog/:id', [BlogController, 'updatePost'])
        .middleware('auth')
        .middleware('admin');

      router
        .delete('blog/:id', [BlogController, 'deletePost'])
        .middleware('auth')
        .middleware('admin');
    })
    .prefix('Blog');
